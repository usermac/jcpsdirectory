...
open(my $edited, ">", "directory-edited-timestamp.html") or die "Can't open directory-edited-timestamp.html:$!"; # 150709 - This simply writes to a file the edited timestamp. This is for Mike because I saw this on footer of Web pages - Brian
...
print $edited "Updated: $time<!--  -->"; # 150708 - Write the timestamp to a file for later linking with the update information. - Brian
