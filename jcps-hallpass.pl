...
open(my $json_schools, ">", "directory-schools.json") or die "Can't open directory-schools.json:$!"; # 目录 红白蓝 150726 - This is the results file to be used on the Web for JSON read-only. - Brian
